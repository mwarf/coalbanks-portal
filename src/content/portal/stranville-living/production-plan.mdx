...
> **✅ All principal photography is now complete.** The final shoot — Brent Hardy's construction interview — wrapped Friday, August 7 at 135 Miners Rd (two-camera, with drone, vehicle, and interior coverage). The mountain-focused schedule below was adjusted as shooting concluded; the campaign has moved into post-production (rough assembly).
...
| **Fri Jul 24** | Production prep, gear turnaround, media offload | Lethbridge | ✅ Complete |
| **Sat Jul 25** | **NEW:** Copperwood "Movie in the Park" community event — Stranville booth, community engagement B-roll | Copperwood. Festivities 3:00 PM, movie 7:00 PM | ✅ Complete |

### Final Shoots (Week of Aug 3)

| Day | Focus | Locations | Status |
|-----|-------|-----------|--------|
| **Tue Jul 28, 9:00 AM** | Kim & Trevor family documentary | Their home, Copperwood | ✅ Complete |
| **Fri Aug 7, 10 AM–1 PM** | Construction voice — Brent Hardy two-camera interview + drone, vehicle, interior coverage (crew 9 AM–2 PM) | 135 Miners Rd (framing stage) | ✅ Complete |

**Principal photography is now complete.** The remaining mountain-trip items (Coleman match-cut Side B, Logan Duplex, dedicated CNP trip) were adjusted as shooting concluded; the campaign has moved into post-production on the footage captured.

### Documentary Profile 1 — Kim & Trevor

**Complete: Tuesday, July 28.** Conversational interview, candid cutaways, and drone footage at their Copperwood home.
...
Copperwood Movie in the Park          :done, evt, 2026-07-25, 1d

section Final Shoots
Brent Hardy Construction Interview   :done, brent, 2026-08-07, 1d
Kim & Trevor Family Profile          :done, family, 2026-07-28, 1d
...
| **135 Miners Rd (framing stage)** | Construction voice — Brent Hardy interview + drone, vehicle, interior coverage | ✅ Filmed Aug 7 |

### Coleman / Crowsnest Pass — Earlier Coverage

| Location | Use | Status |
|----------|-----|--------|
| **Coleman Hemsdale** (8619 25th Ave) | Match-cut Side B, hero interiors, deck + mountain shots | ✅ Staging complete (Jul 22); coverage adjusted as shooting concluded |
| **Logan Duplex Showhome** (8633–8677 24th Ave) | Furnished showhome coverage, FPV sweep | Coverage adjusted at wrap |
| **Aurora Phase 2** | Construction energy, community activity | ✅ Aerial/construction captured |
| **Crowsnest Pass aerials** | Community establishing, golden hour against the Rockies | ✅ CNP lifestyle captured Jul 22–23 |

> **Note:** 72 Kananaskis Wilds (Maycroft) has sold — new owners moved in; its hero coverage role was absorbed by other properties. Mountain lifestyle b-roll (fly fishing and mountain biking with Mike Miechkota) was captured Jul 22–23. With principal photography complete Aug 7, the dedicated mountain-trip items were adjusted and the campaign has moved into post-production.
...
| **Construction** | Brent Hardy | Fri Aug 7, 10 AM–1 PM — office start, then on-site (crew 9 AM–2 PM) | ✅ Confirmed |
...
| Mountain lifestyle b-roll | ✅ Filmed Jul 22–23 | Mike Miechkota — biking + fly fishing, incl. at a Stranville home in Aurora |
| CNP filming family | ⏳ Searching — needed this week | Sheva checking past clients and local contacts (Danielle R. has a possible candidate) |
